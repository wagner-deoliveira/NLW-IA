...
The description should have a maximum of 80 words in the first person and should include the main points of the video.

Use compelling words that capture the reader's attention.

In addition, at the end of the description, include a list of 3 to 10 hashtags in lowercase containing keywords from the video.
